...
?>
<script type="text/javascript" src="../_common/ajax/articles/mediateka.js"></script>
<script type="text/javascript">
var carID = "<?php echo $row['car_id']; ?>";
</script>
...
<div style="display:block; width:'  .intval($images[$key][1]*$ratio) .'px; position:relative;  background:#e3e3e3; margin:10px 0 20px 0; padding:0 0 10px 0;">
		...
		<img src=\'../../_photos/articles/' .$images[$key][0] .'\'  width=\''  .intval($images[$key][1]*$ratio) .'\' height=\'' .intval($images[$key][2]*$ratio) .'\'>
