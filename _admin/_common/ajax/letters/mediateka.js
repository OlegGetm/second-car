...
/* ........................................................................................  */	
	$(".delete_image").click( function() 	{ 
		...
		if (confirm(confirmText)) {
							$.ajax({
										type: 			'POST',   
										url: 				'../_common/ajax/letters/delete_photo.php',
...
/* ........................................................................................  */	
	$(".delete_video").click( function() 	{ 
		...
		if (confirm(confirmText)) {
							$.ajax({
										type: 			'POST',   
										url: 				'../_common/ajax/letters/delete_video.php',
...
/* ........................................................................................  */	
	$(".textSubscribe").click( function() 	{ 
		...
		var btnOK = $('<span />').text('OK').css({'padding-left':'20px', 'text-decoration':'underline', 'cursor':'pointer'}).appendTo(newDIV).click(function() 	{
									...
									$.ajax({
										type: 			'POST',   
										url: 				'../_common/ajax/letters/update_text.php',
										data: 			{	
																'type': 			typeMedia,
																'id': 				curentID,
																'text': 			ta.val()
...
function createPhotoForm(par) {
	...
	var myForm = $('<form/>').attr({'method': 'post', 'enctype': 'multipart/form-data', 'action': '../_common/ajax/letters/add_photo.php' });
	...
	$('<input type="hidden"/>').attr('name', 'letter_id').val(letterID).appendTo(myForm);
	$('<input type="hidden"/>').attr('name', 'date_prefix').val(datePrefix).appendTo(myForm);
...
function createVideoForm(par) {  
	...
	var myForm = $('<form/>').attr({'method': 'post', 'action': '../_common/ajax/letters/add_video.php' });
